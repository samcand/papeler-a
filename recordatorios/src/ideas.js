...
export const IDEAS = [
  ...
  { n: 3, c: 'captura', hecho: true, t: 'Bandeja de entrada universal', d: 'Un sitio donde soltar cualquier cosa sin decidir proyecto ni fecha, y un modo de procesarla de una en una: clasificar es otro trabajo, y mezclarlo con capturar hace que no se capture.' },
  ...
  { n: 44, c: 'avisos', hecho: true, t: 'Resumen matutino', d: 'Al entrar (y como aviso, si están permitidos) el plan del día: las tres cosas que importan, lo que tiene hora, lo atrasado y lo que hiciste ayer.' },
