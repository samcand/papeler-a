...
export const IDEAS = [
  ...
  { n: 125, c: 'vida', estado: 'hecho', t: 'Medallas y estrellas, sin trampas', d: 'Once medallas con bronce, plata y oro, calculadas de lo que ya está medido: constancia, trabajo hecho, palabra cumplida (entregas a tiempo), enfoque medido, revisión semanal, metas logradas, rutina, diario, lecturas, presupuesto e hitos. No se guardan: se recalculan, así que no hay contador que inflar ni medalla que se consiga marcando una casilla. Y tres estrellas al día como mucho, por cosas que pasaron de verdad hoy; un criterio que no aplica deja sitio al siguiente en vez de restar. Nada castiga: perder una racha no quita nada y mañana las estrellas vuelven a cero sin deber nada.' },
  { n: 126, c: 'vida', estado: 'hecho', t: 'Metas de largo plazo, con los años dentro', d: 'Una meta de vida contiene las de cada año y estas las del trimestre, y el avance del padre sale de sus hijas en vez de un número a mano. El horizonte cambia lo que significa ir bien: una meta de vida sin fecha no “va tarde”, va. Una hija abandonada deja de arrastrar al padre, y ninguna puede colgar de su propia hija.' },
  { n: 127, c: 'vida', estado: 'hecho', t: 'El año en una página', d: 'Lo que de verdad pasó en el año, sacado de lo guardado: lo cerrado mes a mes, en qué se fue, la mejor racha, horas medidas, entregas a tiempo, metas cumplidas y las dejadas con su motivo, viajes, lecturas, diario, gasto y medallas. Para revisar en enero con datos en vez de con memoria, y para enseñarlo: se copia, se descarga o se imprime.' },
  { n: 128, c: 'captura', estado: 'hecho', t: 'Añadir con botones, no solo escribiendo', d: 'El botón ⋯ de la caja abre fecha, hora, fecha límite, duración, prioridad, repetición, energía y a dónde va (proyecto y módulo). Lo elegido se queda puesto entre una tarea y la siguiente, porque casi nunca se añade una sola cosa al mismo sitio. Y el orden que menos sorprende: lo escrito manda sobre los botones, y los botones sobre lo que la pantalla da por defecto; la vista previa enseña el resultado ya mezclado.' },
  { n: 129, c: 'tiempo', estado: 'hecho', t: 'Cronómetro en cada tarea', d: 'Un ▶ en cada tarea empieza a medir sin salir de la lista, y una barra abajo dice qué se está midiendo —un reloj corriendo que no se ve acaba contando una noche entera—. Mide con marcas de reloj, así que cerrar la app no le quita tiempo; solo uno a la vez, y empezar en otra tarea guarda lo de la anterior; menos de un minuto no se apunta. Al parar dice lo medido frente a lo que estimaste.' },
  { n: 130, c: 'vida', estado: 'hecho', t: 'La pantalla de metas, rehecha', d: 'La primera versión era un formulario volcado: cada meta abierta con ocho menús, filtros que dejaban la pantalla en blanco y el nombre ya escrito con “lo que quiero conseguir”. Ahora la meta se escribe en una línea (“Leer 24 libros este año” pone meta, unidad y plazo), la lista es compacta con su barra y el botón +1 —que es la acción de todos los días—, las metas salen agrupadas por horizonte en vez de filtradas, y el formulario vive en un panel que se abre solo si hace falta.' },
  { n: 131, c: 'vida', estado: 'hecho', t: 'El ritmo de la meta, no solo el porcentaje', d: 'Una meta no se incumple de golpe: se deja de tocar. Cada suma queda apuntada con su fecha, así que la lista puede decir lo único que de verdad sirve para hacer algo hoy: cuándo fue la última vez (“hace 12 días”) y dónde acabas si sigues igual (“a este ritmo te quedas en 9 de 24”). Las que llevan tres semanas quietas con el plazo abierto salen avisadas arriba, con un botón para sumar ahí mismo, y el panel enseña los últimos 30 días en una tira de barras: cuántos días de verdad la tocaste.' },
];
