...
export const IDEAS = [
  ...
  { n: 9, c: 'captura', estado: 'pendiente', ola: 1, t: 'Autocompletar proyectos y etiquetas al escribir', d: 'Al teclear # o @ se sugiere lo que ya existe, que es como se evita tener "cartera", "Cartera" y "carteras".' },
  ...
  { n: 16, c: 'organizar', estado: 'pendiente', ola: 1, t: 'Archivar en vez de borrar', d: 'Los proyectos terminados no se borran: se archivan, y siguen contando en las estadísticas del año.' },
  { n: 17, c: 'organizar', estado: 'pendiente', ola: 1, t: 'Papelera con recuperación', d: 'Treinta días para arrepentirse de un borrado, porque el botón de confirmar se pulsa en automático.' },
  ...
  { n: 25, c: 'priorizar', estado: 'pendiente', ola: 1, t: 'Las tres cosas del día', d: 'Obligar a elegir tres tareas que harían que el día valga la pena, y enseñarlas por encima del resto.' },
  ...
  { n: 46, c: 'avisos', estado: 'pendiente', ola: 1, t: 'Escalado de las aplazadas', d: 'Si una tarea se pospone cinco veces, preguntar en serio si sigue viva o hay que matarla.' },
  ...
  { n: 54, c: 'equipo', estado: 'pendiente', ola: 1, t: 'Dependencias externas: dueño, fecha y seguimiento', d: 'El coautor, la revista, el estudiante o el banco: quién lo tiene, desde cuándo y cuándo perseguirlo, con aviso cuando se pasa de plazo.' },
  ...
  { n: 66, c: 'inversiones', estado: 'pendiente', ola: 1, t: 'Importar movimientos del bróker', d: 'Leer el CSV de operaciones y cuadrar la cartera sola, que copiar a mano es donde entran los errores.' },
  ...
  { n: 75, c: 'academico', estado: 'pendiente', ola: 1, t: 'Banco de tareas por curso reutilizable', d: 'Clonar el semestre anterior con las fechas corridas, en vez de rehacerlo cada enero.' },
  ...
  { n: 89, c: 'proyectos', estado: 'pendiente', ola: 1, t: 'Fecha final probabilística (PERT + Monte Carlo)', d: 'Duración optimista, probable y pesimista por tarea, simulación del plan y una fecha con probabilidad — alimentada por tu factor de calibración medido, no por un optimismo genérico.' },
  ...
  { n: 95, c: 'datos', estado: 'pendiente', ola: 1, t: 'Deshacer global e historial de versiones', d: 'Una franja de "deshacer" tras cada borrado y copias automáticas de los últimos días.' },
  ...
  { n: 101, c: 'proyectos', estado: 'pendiente', ola: 1, t: 'Simulación "¿qué pasa si?" y propagación del impacto', d: 'Retrasar una tarea, alargar otra o mover un hito, y ver antes de tocar nada qué fechas se mueven en cascada y si la entrega sigue en pie.' },
  { n: 102, c: 'priorizar', estado: 'pendiente', ola: 1, t: 'Tu capacidad real entre los cinco módulos', d: 'Horas disponibles por semana descontando clases, ensayo y servicio, frente a lo que ya has comprometido, con un mapa de calor semanal. El recurso escaso que provoca todos los choques eres tú.' },
  { n: 103, c: 'proyectos', estado: 'pendiente', ola: 1, t: 'Salud explicada y aviso temprano', d: 'Un indicador por compromiso con las razones detrás: holgura consumida, dependencias externas vencidas, tu carga y estancamiento. Lo que importa no es el número sino el porqué, antes de que se ponga en rojo.' },
