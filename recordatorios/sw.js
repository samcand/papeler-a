...
const VERSION = 'recordatorios-v4';
const ARCHIVOS = [
  ...
  './src/buscador.js', './src/logros.js', './src/limites.js', './src/dependencias.js', './src/cartera.js', './src/notas.js', './src/colecciones.js', './src/objetivos.js', './src/mantenimiento.js',
  ...
  './src/views/logros.js', './src/views/gastos.js', './src/views/personas.js', './src/views/rutinas.js', './src/views/viajes.js',
  '../src/ui.js',
];
