...
const VERSION = 'recordatorios-v5';
const ARCHIVOS = [
  ...
  './src/buscador.js', './src/logros.js', './src/anio.js', './src/limites.js', './src/dependencias.js', './src/cartera.js', './src/notas.js', './src/colecciones.js', './src/objetivos.js', './src/mantenimiento.js',
