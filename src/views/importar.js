...
import { el, button, chip, section, toast, render } from '../ui.js';
...
export function importarView(root, { navigate, query }) {
  ...
  if (!codigo) {
    render(cuerpo, el('div', { class: 'card' },
  ...
  render(cuerpo, el('div', { class: 'card' }, el('p', { class: 'muted' }, 'Leyendo el código…')));
