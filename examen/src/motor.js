...
export const MODELOS_SIMULACRO = {
  completo: {
    nombre: 'Completo', minutos: 150,
    reparto: {
      matematicas: 16, trigonometria: 6, abstracto: 10, fisica: 8, quimica: 8, salud: 8,
      geografia: 6, historia: 6, ciudadania: 6, cotidiana: 6, lectura: 10, lengua: 6, literatura: 5, filosofia: 5, ingles: 12,
    },
  },
  corto: {
    nombre: 'Corto', minutos: 64,
    reparto: {
      matematicas: 8, trigonometria: 3, abstracto: 5, fisica: 4, quimica: 4, salud: 4,
      geografia: 3, historia: 3, ciudadania: 3, cotidiana: 3, lectura: 5, lengua: 3, literatura: 3, filosofia: 3, ingles: 6,
    },
  },
  express: {
    nombre: 'Exprés', minutos: 32,
    reparto: {
      matematicas: 4, trigonometria: 2, abstracto: 2, fisica: 2, quimica: 2, salud: 2,
      geografia: 2, historia: 2, ciudadania: 2, cotidiana: 2, lectura: 2, lengua: 2, literatura: 2, filosofia: 2, ingles: 2,
    },
  },
};
...
function barajarPorAsignatura(preguntas, rnd) {
  const orden = ['matematicas', 'trigonometria', 'abstracto', 'fisica', 'quimica', 'salud',
    'geografia', 'historia', 'ciudadania', 'cotidiana', 'lectura', 'lengua', 'literatura', 'filosofia', 'ingles'];
